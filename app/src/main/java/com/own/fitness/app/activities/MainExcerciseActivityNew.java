...
import com.own.fitness.app.sortnameclass.a.i;
import com.own.fitness.app.sortnameclass.a.j;
import com.own.fitness.app.sortnameclass.a.k;
import com.own.fitness.app.sortnameclass.a.l;
import com.own.fitness.app.sortnameclass.a.m;
import com.own.fitness.app.sortnameclass.a.n;
import com.own.fitness.app.sortnameclass.a.o;
import com.own.fitness.app.sortnameclass.a.q;
import com.own.fitness.app.sortnameclass.a.r;
import com.own.fitness.app.sortnameclass.a.s;
import com.own.fitness.app.sortnameclass.a.t;
import com.own.fitness.app.sortnameclass.a.u;
import com.own.fitness.app.sortnameclass.a.v;
import com.own.fitness.app.sortnameclass.a.w;
import com.own.fitness.app.sortnameclass.a.x;
import com.own.fitness.app.sortnameclass.a.y;
...
public class MainExcerciseActivityNew extends AppCompatActivity {
    boolean boola;
    boolean boolb;
    boolean boolc;
    boolean boold;
...
//    AdmobAds u = null;
    ...
    public static int e(MainExcerciseActivityNew mainExcerciseActivityNew) {
    ...
    public void mainExcTimer(long j, int i2, float f) {
        ...
        this.excersiseTimer = new CountDownTimer(j, 1000) {
            ...
            public void onFinish() {
                ...
                StringBuilder sb;
                TextView textView;
                MainExcerciseActivityNew mainExcerciseActivityNew = MainExcerciseActivityNew.this;
                mainExcerciseActivityNew.boola = false;
                RoundCornerProgressBar pbar = mainExcerciseActivityNew.progressbar;
                float f = this.f768a;
                this.f768a = f + 1.0f;
                pbar.setProgress(f);
                MainExcerciseActivityNew.this.topProgressBar.setProgress(100);
                if (MainExcerciseActivityNew.this.excCouner < MainExcerciseActivityNew.this.workoutDataList.size()) {
                    for (int i2 = 0; i2 < MainExcerciseActivityNew.this.excCouner; i2++) {
                        MainExcerciseActivityNew mainExcerciseActivityNew2 = MainExcerciseActivityNew.this;
                        mainExcerciseActivityNew2.topProgressBar = (ProgressBar) mainExcerciseActivityNew2.layoutprogress.findViewById(i2);
                        MainExcerciseActivityNew.this.topProgressBar.setMax(((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getImageIdList().length * ((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getExcCycles());
                        MainExcerciseActivityNew.this.topProgressBar.setProgress(((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getImageIdList().length * ((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getExcCycles());
                    }
                }
                MainExcerciseActivityNew.e(MainExcerciseActivityNew.this);
                TextView textView1 = MainExcerciseActivityNew.this.nextExNumber;
                textView1.setText(MainExcerciseActivityNew.this.getResources().getString(R.string.next) + " " + (MainExcerciseActivityNew.this.excCouner + 1) + "/" + MainExcerciseActivityNew.this.workoutDataList.size());
                if (MainExcerciseActivityNew.this.excCouner < MainExcerciseActivityNew.this.workoutDataList.size()) {
                    MainExcerciseActivityNew.this.restScreen.setVisibility(View.VISIBLE);
                    MainExcerciseActivityNew.this.pauseRestTime.setVisibility(View.VISIBLE);
                    MainExcerciseActivityNew.this.resumRestTime.setVisibility(View.GONE);
                    MainExcerciseActivityNew.this.progressbar.setMax((float) ((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getExcCycles());
                    TextView h = MainExcerciseActivityNew.this.tvProgress;
                    int i3 = this.b;
                    this.b = i3 + 1;
                    h.setText(String.valueOf(i3));
                    if (MainExcerciseActivityNew.this.workoutData.getImageIdList().length > 1) {
                        textView = MainExcerciseActivityNew.this.tvProgressMax;
                        sb = new StringBuilder();
                        sb.append(((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getExcCycles());
                        str = "";
                    } else {
                        textView = MainExcerciseActivityNew.this.tvProgressMax;
                        sb = new StringBuilder();
                    ...
                    this.f768a = 1.0f;
                    this.b = 1;
                    MainExcerciseActivityNew mainExcerciseActivityNew3 = MainExcerciseActivityNew.this;
                    if (!mainExcerciseActivityNew3.boolb) {
                        mainExcerciseActivityNew3.a(mainExcerciseActivityNew3.t);
                    }
                    MainExcerciseActivityNew mainExcerciseActivityNew4 = MainExcerciseActivityNew.this;
                    if (mainExcerciseActivityNew4.y == 1) {
                        mainExcerciseActivityNew4.absWomenApplication.speak(MainExcerciseActivityNew.this.getString(R.string.takerestspeak));
                    }
                } else {
                    Intent intent = new Intent(MainExcerciseActivityNew.this, complete.class);
                    intent.putExtra("daynumber", ((Bundle) Objects.requireNonNull(MainExcerciseActivityNew.this.getIntent().getExtras())).getInt("day_value_number"));
                    intent.putExtra("day", MainExcerciseActivityNew.this.day);
                    int size = MainExcerciseActivityNew.this.workoutDataList.size();
                    int i4 = 0;
                    for (int i5 = 0; i5 < MainExcerciseActivityNew.this.workoutDataList.size(); i5++) {
                        i4 = i4 + ((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(i5)).getImageIdList().length + 30;
                    }
                    intent.putExtra("totalExc", size);
                    intent.putExtra("totalTime", i4);
                    MainExcerciseActivityNew.this.startActivity(intent);
//                    if (MainExcerciseActivityNew.this.interstitial.isLoaded()) {
//                        MainExcerciseActivityNew.this.interstitial.show();
//                    }
                    finish();
                }
                MainExcerciseActivityNew mainExcerciseActivityNew5 = MainExcerciseActivityNew.this;
                double excDayProgress = (double) mainExcerciseActivityNew5.databaseOperations.getExcDayProgress(MainExcerciseActivityNew.this.day);
                double size2 = (double) ((float) MainExcerciseActivityNew.this.workoutDataList.size());
                Double.isNaN(size2);
                Double.isNaN(excDayProgress);
                mainExcerciseActivityNew5.progress = excDayProgress + (100.0d / size2);
                MainExcerciseActivityNew mainExcerciseActivityNew6 = MainExcerciseActivityNew.this;
                mainExcerciseActivityNew6.dataBaseProgressUpdate(mainExcerciseActivityNew6.progress);
                MainExcerciseActivityNew mainExcerciseActivityNew7 = MainExcerciseActivityNew.this;
                mainExcerciseActivityNew7.r = 1.0f;
                mainExcerciseActivityNew7.mainExcCounter = 1;
            }

            public void onTick(long j) {
                MainExcerciseActivityNew mainExcerciseActivityNew;
                TextView h = null;
                String valueOf = null;
                MainExcerciseActivityNew mainExcerciseActivityNew2 = MainExcerciseActivityNew.this;
                ...
                try {
                    if (((WorkoutData) mainExcerciseActivityNew2.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getImageIdList().length > 2) {
                        if (this.b <= ((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getExcCycles()) {
                            if (this.f768a == 1.0f) {
                                h = MainExcerciseActivityNew.this.tvProgress;
                                valueOf = String.valueOf(1);
                                h.setText(valueOf);
                            } else if (this.f768a % ((float) ((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getImageIdList().length) == 0.0f) {
                                h = MainExcerciseActivityNew.this.tvProgress;
                                int jk = this.b;
                                this.b = jk + 1;
                        ...
                        if (this.b == ((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getExcCycles() + 1) {
                            MainExcerciseActivityNew.this.tvProgress.setText(String.valueOf(((WorkoutData) MainExcerciseActivityNew.this.workoutDataList.get(MainExcerciseActivityNew.this.excCouner)).getExcCycles()));
                        }
                        RoundCornerProgressBar i2 = MainExcerciseActivityNew.this.progressbar;
                        float f = this.f768a;
                        this.f768a = 1.0f + f;
                        i2.setProgress(f);
                        MainExcerciseActivityNew.this.topProgressBar.setProgress((int) this.f768a);
                        MainExcerciseActivityNew.this.timerrr = j;
                        MainExcerciseActivityNew.this.mainExcCounter = this.b;
                        mainExcerciseActivityNew = MainExcerciseActivityNew.this;
                    ...
                    RoundCornerProgressBar i22 = MainExcerciseActivityNew.this.progressbar;
                    float f2 = this.f768a;
                    this.f768a = 1.0f + f2;
                    i22.setProgress(f2);
                    MainExcerciseActivityNew.this.topProgressBar.setProgress((int) this.f768a);
                ...
                RoundCornerProgressBar i222 = MainExcerciseActivityNew.this.progressbar;
...
//                super.onAdClosed();
//                MainExcerciseActivityNew.this.interstitial.loadAd(MainExcerciseActivityNew.this.adRequest);
//            }
//        });
...
//            public void onAdClosed() {
//                super.onAdClosed();
//                MainExcerciseActivityNew.this.mInterstitialAdAtBackPress.loadAd(MainExcerciseActivityNew.this.adRequest1);
//            }
//        });
    ...
    public void a(long j) {
        ...
        this.restTimer = new CountDownTimer(j, 1000) {
            public void onFinish() {
                ...
                mainExcerciseActivityNew.countRestTimer.setText(String.valueOf(MainExcerciseActivityNew.this.t / 1000));
                MainExcerciseActivityNew.this.restScreen.setVisibility(View.GONE);
                MainExcerciseActivityNew.this.pauseMainExcersise.setVisibility(View.VISIBLE);
                MainExcerciseActivityNew.this.resumeMainExcersise.setVisibility(View.GONE);
                MainExcerciseActivityNew mainExcerciseActivityNew2 = MainExcerciseActivityNew.this;
                ...
                if (!mainExcerciseActivityNew3.boola) {
                    mainExcerciseActivityNew3.mainExcTimer(calculateExTime, mainExcerciseActivityNew3.mainExcCounter, MainExcerciseActivityNew.this.r);
                }
            }
            ...
            public void onTick(long j) {
                ...
                MainExcerciseActivityNew.this.countRestTimer.setText(String.valueOf(j2));
                MainExcerciseActivityNew.this.timerrr = j;
                if (j2 < 4) {
                    MainExcerciseActivityNew mainExcerciseActivityNew2 = MainExcerciseActivityNew.this;
                    if (mainExcerciseActivityNew2.y == 1) {
                        ...
                        if (j2 == 2) {
                            MainExcerciseActivityNew.this.absWomenApplication.speak("2");
                        }
                        if (j2 == 1) {
                            MainExcerciseActivityNew.this.absWomenApplication.speak("1");
                            MainExcerciseActivityNew.this.absWomenApplication.speak(MainExcerciseActivityNew.this.getString(R.string.start));
                        }
                    }
                }
            }
...
//    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        rel.setBackgroundColor(getResources().getColor(R.color.women_color));

        tltl = (RelativeLayout) findViewById(R.id.tltl);
        tltl.setBackgroundColor(getResources().getColor(R.color.women_color));

        t1 = (RelativeLayout) findViewById(R.id.t1);
        t1.setBackgroundColor(getResources().getColor(R.color.women_color));

        rest_counting = (TextView) findViewById(R.id.rest_counting);
        rest_counting.setTextColor(getResources().getColor(R.color.women_color));

        this.nextExerciseName = (TextView) findViewById(R.id.nextExerciseName);
        nextExerciseName.setTextColor(getResources().getColor(R.color.women_color));
...
//        refreshAd1();
        ...
        this.progressbar.setProgressColor(getResources().getColor(R.color.women_color));
...
//        }
    ...
    public void readyToGoFun(long j) {
        ...
        this.readyToGoTimer = new CountDownTimer(j, 1000) {
            public void onFinish() {
                MainExcerciseActivityNew.this.timerprogress.setProgress(0);
                MainExcerciseActivityNew.this.redytogo.setVisibility(View.GONE);
                MainExcerciseActivityNew.this.pauseMainExcersise.setVisibility(View.VISIBLE);
                MainExcerciseActivityNew.this.resumeMainExcersise.setVisibility(View.GONE);
                MainExcerciseActivityNew mainExcerciseActivityNew = MainExcerciseActivityNew.this;
                ...
                if (!mainExcerciseActivityNew2.boola) {
                    mainExcerciseActivityNew2.mainExcTimer(calculateExTime, mainExcerciseActivityNew2.mainExcCounter, MainExcerciseActivityNew.this.r);
                }
            }

            public void onTick(long j) {
                long j2 = j - 1000;
                MainExcerciseActivityNew.this.timerprogress.setProgress(((int) j2) / 1000);
                long j3 = j2 / 1000;
                MainExcerciseActivityNew.this.count.setText(String.valueOf(j3));
                MainExcerciseActivityNew.this.timerrr = j;
                if (j3 < 4) {
                    MainExcerciseActivityNew mainExcerciseActivityNew = MainExcerciseActivityNew.this;
                    if (mainExcerciseActivityNew.y == 1) {
