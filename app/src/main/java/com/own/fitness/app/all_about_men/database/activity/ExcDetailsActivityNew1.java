...
public class ExcDetailsActivityNew1 extends AppCompatActivity {
    int dayvalue;
    ...
    int[] s = {R.array.buttock_cycles1, R.array.weightloss_cycles1, R.array.abs_cycles1, R.array.fatburn_cycles1, R.array.morning_cycle1, R.array.evening_cycle1};
    ...
    public void onBackPressed() {
        ...
        DatabaseOperations1 databaseOperations2 = this.databaseOperations;
        String str = this.day;
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        decrement.setBackgroundColor(getResources().getColor(R.color.men_color));

        display= (EditText) findViewById(R.id.display);
        display.setBackgroundColor(getResources().getColor(R.color.men_color));

        increment= (Button) findViewById(R.id.increment);
        increment.setBackgroundColor(getResources().getColor(R.color.men_color));
        ...
        toolbar.setNavigationOnClickListener(view -> {
            DatabaseOperations1 b = ExcDetailsActivityNew1.this.databaseOperations;
            String a2 = ExcDetailsActivityNew1.this.day;
            ExcDetailsActivityNew1 excDetailsActivityNew = ExcDetailsActivityNew1.this;
            b.insertExcCycles(a2, excDetailsActivityNew.createJsonArray(excDetailsActivityNew.databaseOperations.getDayExcCycles(ExcDetailsActivityNew1.this.day)));
            if (ExcDetailsActivityNew1.this.editedValue) {
                Toast.makeText(ExcDetailsActivityNew1.this.getApplicationContext(), "Excercise cycles are updated.", Toast.LENGTH_SHORT).show();
            }

             ExcDetailsActivityNew1.this.editedValue = false;
            ExcDetailsActivityNew1.this.finish();
        });
        ...
        this.numpicker.setValueChangedListener((i1, actionEnum) -> {
            ExcDetailsActivityNew1.this.editCycle = i1;
            ExcDetailsActivityNew1.this.editedValue = true;
        });
    }
