...
import com.own.fitness.app.activities.ExcDetailsActivityNew;
import com.own.fitness.app.sortnameclass.b.a;
...
public class IndividualDayAdapter extends RecyclerView.Adapter<IndividualDayAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(IndividualDayAdapter individualDayAdapter, View view) {
            ...
            this.b.setTextColor(view.getResources().getColor(R.color.women_color));
    ...
    public void a(ViewHolder viewHolder, int i) {
        ...
        if (adapterPosition < this.workoutDataList.size()) {
            Intent intent = new Intent(this.context, ExcDetailsActivityNew.class);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        viewHolder.d.setOnClickListener(new a(this, viewHolder, i));
    }
